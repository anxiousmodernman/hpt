...
func GenerateTargetServerKeys(targetName, localKeystorePath, output string) ([]byte, error) {
	...
	localKP := KeyPair{targetName, pub.String(), priv.String()}
